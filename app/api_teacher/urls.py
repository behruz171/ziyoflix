...
urlpatterns = [
    ...
    path('teacher/assignments/submissions/<int:submission_id>/grade/', assignment_views.GradeAssignmentSubmissionAPIView.as_view(), name='grade-assignment-submission'),
